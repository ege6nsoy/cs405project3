...
void main()
{
	...
	vec3 specularComponent = spec * lightColor;

	// Apply the lighting components to the texture color
	vec3 finalColor = (ambientComponent + diffuseComponent + specularComponent) * texture2D(tex, vTexCoord).rgb;
